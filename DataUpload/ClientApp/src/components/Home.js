...
export class Home extends Component {
    ...
    handleUpload = () => {
        ...
        axios.post(`${this.state.url}/api/Deal`, formData, config)
            .then((res) => {
                this.setState({
                    fileList: [],
                    uploading: false,
    ...
    getDeals = () => {
        ...
        axios.get(`${this.state.url}/api/Deal/GetAllVehicles`, {
    ...
    getMostSoldVehicles = () => {
        axios.get(`${this.state.url}/api/Deal/GetMostPopularVehicle`)
            .then(res => {
